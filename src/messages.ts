...
export const changeTenantLabel: string = 'Change active tenant';
export const unableToAccessOrganization: string = 'Unable to access the "%s" organization. Make sure you\'re signed into the right Microsoft account or using the right tenant.';
